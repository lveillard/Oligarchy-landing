          ...
          <div className="hero-head">
            ...
            <div className="hero-body">
              <div className="container has-text-centered">
                <h1 className="title">
                  Reclutamiento de altos potenciales en empresas de éxito
                    </h1>
...
¿Perteneces al 5%?                   </h2>
   ...
   {/* entre plantas*/}
      ...
      <div className="buttons is-centered">
          <button className="button is-size-4 is-warning">Candidatos</button>
            <button className="button is-size-4 is-link">Empresas</button>
  </div>
        </div>
